...
import { yarnLockFile, appHtml, appIndexJs, appPath, appPackageJson, appTsConfig, appPublic } from '../config/paths';
...
if (process.env.HOST) {
  console.log(cyan(`Attempting to bind to HOST environment variable: ${yellow(bold(process.env.HOST))}`));
